...
def naked_twins(values):
    ...
    actual_pairs = [[box1,box2] for box1 in possible_pairs for box2 in peers[box1] if set(values[box1])==set(values[box2]) ]

    # Remove the instances from the peers
    for i in range(len(actual_pairs)):
        box1 = actual_pairs[i][0]
        box2 = actual_pairs[i][1]
